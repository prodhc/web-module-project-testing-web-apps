...
test('renders all firstName, lastName and email text when submitted. Does NOT render message if message is not submitted.', async () => {
	...
	expect(firstNameDisplay).toHaveTextContent(/steve/i);

	expect(lastNameDisplay).toBeTruthy();
	expect(lastNameDisplay).toBeInTheDocument();
	expect(lastNameDisplay).toHaveTextContent(/clark/i);

	expect(emailDisplay).toBeTruthy();
	expect(emailDisplay).toBeInTheDocument();
	expect(emailDisplay).toHaveTextContent(/test@gmail.com/i);
